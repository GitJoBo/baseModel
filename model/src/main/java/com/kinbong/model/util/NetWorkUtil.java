...
//    public static final int noneNet=-1;
    ...
    public static boolean isNetAndShow() {
        if (!isNetworkConnected()) {
            ToastUtil.showToast(R.string.line_net);
            return false;
        }
        if (!isNetworkAvailable()) {
            ToastUtil.showToast(R.string.net_no_available);
            return false;
        }
        return true;
    }
    ...
    public static boolean isNetworkConnected() {
        ...
        {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) ModelApp.sContext
...
//        ConnectivityManager connMgr = (ConnectivityManager) BaseApp.sContext
//                .getSystemService(Context.CONNECTIVITY_SERVICE);
...
//    }
    ...
    public static boolean isWifiOpen() {
        ...
        NetworkInfo[] networkInfos = getWorkInfos();
    ...
    public static NetworkInfo[] getWorkInfos() {
        ConnectivityManager cm = (ConnectivityManager) ModelApp.sContext.getSystemService(Context.CONNECTIVITY_SERVICE);
