...
public class LoadRecyclerView extends RecyclerView {
    ...
    public void loadMoreComplete() {
        if (loadingMoreFooter != null&&loadingMoreFooter.isVisible()) {
            loadingMoreFooter.setGone();
        }
        isLoadingData = false;
    }
...
public void register(){
    if(mAdapter!=null&&mDataObserver!=null) mAdapter.registerAdapterDataObserver(mDataObserver);
}
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && loadMoreListener != null && !isLoadingData && canloadMore) {
            ...
            if (layoutManager.getChildCount() > 0
                    ...
                    &&layoutManager.getItemCount() > layoutManager.getChildCount()&&!isLoadingData) {
                if (loadingMoreFooter != null) {
