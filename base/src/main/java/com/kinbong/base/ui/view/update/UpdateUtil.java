...
public class UpdateUtil {
    ...
    private static final String PREFS = MySP.PACKAGE;
    private static final String PREFS_IGNORE = MySP.PACKAGE+".ignore";
    private static final String PREFS_UPDATE = MySP.PACKAGE+".update";
